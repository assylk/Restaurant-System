...
if ($_SERVER["REQUEST_METHOD"] == "GET") {
    ...
    if (!empty($reservedTableIDs)) {
        ...
        if ($availableResult) {
            ...
            $reservedTableIDsString = implode(",", $reservedTableIDs);
            $reservationLink = "reservation.php?reservation_date=$selectedDate&head_count=$head_count&reservation_time=$selectedTime&reserved_table_id=$reservedTableIDsString";
        ...
        $reservationLink = "reservation.php?reservation_date=$selectedDate&head_count=$head_count&reservation_time=$selectedTime&reserved_table_id=0";
        header("Location:$reservationLink");
    }
