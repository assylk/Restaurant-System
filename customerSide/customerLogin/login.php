                    ...
                    if ($password === $row["password"]) {
                        ...
                        if ($result_member) {
                            ...
                            if ($membership_row) {
                                ...
                                header("location: ../home/index.php"); // Redirect to the home page
                                exit;
                            } else {
    ...
    <div class="login-container">
        <div class="login_wrapper">
            <a class="nav-link" href="../home/home.php#hero">
                <h1 class="text-center" style="font-family:Copperplate; color:white;">LOGIN</h1><span
                    class="sr-only"></span>
            </a>
            ...
            <div class="wrapper">
                ...
                <form action="login.php" method="post">
                    ...
                    <button class="btn btn-dark" style="background-color:black;" type="submit" name="submit"
                        value="Login">Login</button>

                </form>

                <p style="margin-top:1em; color:white;">Don't have an account? <a href="register.php" style="">Proceed
                        to Register</a></p>
            </div>
        </div>
    </div>
