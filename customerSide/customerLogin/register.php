    ...
    <div class="register-container">
        <div class="register_wrapper">
            ...
            <a class="nav-link" href="../home/home.php#hero">
                <h1 class="text-center" style="font-family:Copperplate; color:white;"> REGISTER</h1><span
                    class="sr-only"></span>
            </a><br>
            ...
            <form action="register.php" method="post">
                ...
                <button style="background-color:black;" class="btn btn-dark" type="submit" name="register"
                    value="Register">Register</button>

            </form>

            <p style="margin-top:1em; color:white;">Already have an account? <a style="text-decoration:none;"
                    href="../customerLogin/login.php">Proceed to Login</a></p>
        </div>
    </div>
</body>
</html>