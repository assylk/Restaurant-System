...
<body class="sb-nav-fixed">
    <nav class="sb-topnav navbar navbar-expand"
        ...
        <!-- Navbar Brand-->
        <a class="navbar-brand ps-3" href="../panel/pos-panel.php" style="color:#e42a33">Staff Panel</a>

    </nav>
    <div id="layoutSidenav">
        <div id="layoutSidenav_nav">
            <nav class="sb-sidenav accordion "
                style="background-color:white;color:#e42a33;box-shadow: rgba(0, 0, 0, 0.16) 0px 1px 4px;"
                id="sidenavAccordion">
