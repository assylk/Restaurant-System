        ...
        <div class="col-md-8">
            ...
            if ($cart_result && mysqli_num_rows($cart_result) > 0) {
                while ($cart_row = mysqli_fetch_assoc($cart_result)) {
                    ...
                    echo '<td>DT ' . number_format($item_price,2) . '</td>';
                    echo '<td>' . $quantity . '</td>';
            ...
            ?>
                    ...
                    <div class="text-right">
                        <?php 
                        echo "<strong>Total:</strong> DT " . number_format($cart_total, 2) . "<br>";
                        echo "<strong>Tax (10%):</strong> DT " . number_format($cart_total * $tax, 2) . "<br>";
                        $GRANDTOTAL = $tax * $cart_total + $cart_total;
                        echo "<strong>Grand Total:</strong> DT " . number_format($GRANDTOTAL, 2);
                        ?>
                    </div>
                </div>
            </div>
            <br>
            <a href="flouci.php?amount=<?php echo $GRANDTOTAL ?>&bill_id=<?php echo $bill_id; ?>"><button type="submit"
    ...
    <div class="container-fluid pt-5 pl-3 pr-3">
        ...
        <form action="creditCard.php?bill_id=<?php echo $bill_id; ?>" method="post">
            ...
            <div class="form-group">
                ...
                <input type="text" id="cardField" name="cardNumber" maxlength="19" minlength="15" class="form-control"
                    placeholder="1234567890123456 (15 to 19 digits)" required>
            </div>
            <div class="form-group">
                <label for="expiryDate">Expiry Date</label>
                <input type="text" id="expiryDate" name="expiryDate" pattern="(0[1-9]|1[0-2])\/[0-9]{4}" maxlength="7"
                    placeholder="MM/YYYY" class="form-control" required>
            </div>
            <div class="form-group">
                <label for="securityCode">Security Code</label>
                <input type="text" id="securityCode" name="securityCode" maxlength="3" class="form-control"
                    placeholder="CCV" pattern="[0-9]{3}" required>
            ...
            <div class="form-check">
                ...
                <label class="form-check-label" for="privacyCheckbox">I agree to the Private Data Terms and
                    Conditions</label><br>
                <small id="privacyHelp" class="form-text text-muted">By checking the box you understand we will save
                    your credit card information.</small>
            </div>
