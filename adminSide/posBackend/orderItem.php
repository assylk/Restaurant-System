            ...
            <div class="col-md-4 order-md-2 m-1" id="cart-section">
                <div class="container-fluid pt-5 pl-600 pr-6 row mt-3" style="max-width: 200%; width:150%;">
                    <div class="cart-section">
                            ...
                            <table class="table table-bordered ">
                                <tbody>
                                    <tr>
                                        ...
                                        <td>DT <?php echo number_format($cart_total, 2); ?></td>
                                    </tr>
                                    <tr>
                                        <td><strong>Cart Taxed</strong></td>
                                        <td>DT <?php echo number_format($cart_total * $tax, 2); ?></td>
                                    </tr>
                                    <tr>
                                        <td><strong>Grand Total</strong></td>
                                        <td>DT <?php echo number_format(($tax * $cart_total) + $cart_total, 2); ?></td>
                                    </tr>
                                </tbody>
                            </table>
                        </div>
                        ...
                        //echo "Cart Total: DT " . $cart_total;
                        //echo "<br>Cart Taxed: DT " . $cart_total * $tax;
                        //echo "<br>Grand Total: DT " . $tax * $cart_total + $cart_total;
