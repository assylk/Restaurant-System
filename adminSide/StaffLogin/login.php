    ...
    <section id="signup">
        <div class="container my-6 ">
            <a class="nav-link" href="../../customerSide/home/home.php">
                <h1 class="text-center" style="font-family:Copperplate; color:gray;"> Staff Dashboard</h1><span
                    class="sr-only"></span>
            </a>
                ...
                <form action="login_process.php" method="post">
                    <div class="form-group">
                        ...
                        <input type="number" id="account_id" name="account_id" placeholder="Enter Account ID" required
                            class="form-control <?php echo (!empty($account_id)) ? 'is-invalid' : ''; ?>"
                    ...
                    <div class="form-group">
                        <button class="btn btn-secondary w-100" type="submit" name="submit" value="Login">Login</button>
                    </div>
                </form>
            </div>
</body>
