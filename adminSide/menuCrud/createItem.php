    ...
    <h3>Create New Item</h1>
        ...
        <form method="POST" action="success_create.php" class="ht-600 w-50">
            ...
            <div class="form-group">
                ...
                'is-invalid'; ?>" id="item_id" required item_id="item_id" placeholder="H88"
                    value="<?php echo $item_id; ?>"><br>
            ...
            <div class="form-group">
                ...
                <input type="text" name="item_name" id="item_name" placeholder="Spaghetti" required
                    class="form-control <?php echo (!empty($itemname_err)) ? 'is-invalid' : ''; ?>"><br>
            ...
            <div class="form-group">
                ...
                <select name="item_type" id="item_type" class="form-control"
                    placeholder="Select Item Type <?php echo (!empty($itemtype_err)) ? 'is-invalid' : ''; ?>" required>
                    <option value="">Select Item Type</option>
                    <option value="Breakfast">Steak & Ribs</option>
            ...
            <div class="form-group">
                ...
                <select name="item_category" id="item_category"
                    ...
                    <option value="Drinks and Tea">Drinks And Tea</option>
                </select>
                <span class="invalid-feedback"></span>
            </div><br>
            ...
            <div class="form-group">
                ...
                <input min='0.01' type="number" name="item_price" id="item_price" placeholder="12.34" step="0.01"
                    required class="form-control <?php echo (!empty($itemprice_err)) ? 'is-invalid' : ''; ?>"><br>
                <span class="invalid-feedback"></span>
            </div>

            <div class="form-group">
                <label for="item_description">Item Description :</label>
                <textarea name="item_description" id="item_description" rows="4" placeholder="The dish...." required
                    class="form-control <?php echo (!empty($itemdescription_err)) ? 'is-invalid' : ''; ?>"></textarea><br>
                <span class="invalid-feedback"></span>
            </div>
